...
function render(inputs, position=[0,0,0]) {
  ...
  for (let i = 0; i < verts.length; i++) {
    ...
    rverts[i][0] = (((verts[i][0]+position[0])-x)/realz)*screendist+centerx;
    rverts[i][1] = (((verts[i][1]+position[1])-y+400)/realz)*screendist+centery;
    if (vertsen==true) {
    ctx.fillStyle=color;
...
{
"version": 1.1,
"vertexs": [[-100,-100,-50],[100,100,-50],[-100,100,-50],[100,-100,-50],[-100,-100,50],[100,100,50],[-100,100,50],[100,-100,50]],
"edges": [[1,3],[0,2],[0,3],[1,2],[1,5],[2,6],[3,7],[0,4],[4,6],[4,7],[5,7],[5,6]],"faces": [[4,7,5,6],[5,1,2,6],[0,4,7,3],[0,4,6,2],[1,5,7,3],[0,3,1,2]]
}, 
"model2": {
"version": 1.1,
"vertexs": [[-25,0,-12.5],[25,50,-12.5],[-25,50,-12.5],[25,0,-12.5],[-25,0,12.5],[25,50,12.5],[-25,50,12.5],[25,0,12.5],[-50,-50,-25],[50,50,-25],[-50,50,-25],[50,-50,-25],[-50,-50,25],[50,50,25],[-50,50,25],[50,-50,25]],
"edges": [[1,3],[0,2],[0,3],[1,2],[1,5],[2,6],[3,7],[0,4],[4,6],[4,7],[5,7],[5,6]],
"faces": [[4,7,5,6],[5,1,2,6],[0,4,7,3],[0,4,6,2],[1,5,7,3],[0,3,1,2]]
}, 
"pillar": {
"version": 1.1,
"vertexs": [[-50,0,-25],[50,-1200,-25],[-50,-1200,-25],[50,0,-25],[-50,0,25],[50,-1200,25],[-50,-1200,25],[50,0,25],[-70,0,-40],[70,-20,-40],[-70,-20,-40],[70,0,-40],[-70,0,40],[70,-20,40],[-70,-20,40],[70,0,40],[-70,-1180,-40],[70,-1200,-40],[-70,-1200,-40],[70,-1180,-40],[-70,-1180,40],[70,-1200,40],[-70,-1200,40],[70,-1180,40]],
...
var version = 1.1;
var angle = 0;
var cubes = [[models['model'], [-100,-200,0]], [models['pillar'], [700,0,0]],[models['pillar'], [-700,0,0]],[models['pillar'], [700,0,600]],[models['pillar'], [-700,0,600]],[models['pillar'], [700,0,1200]],[models['pillar'], [-700,0,1200]]];
var facesen = true;
var edgesen = true;
var vertsen = false;
var screendist = 300;
