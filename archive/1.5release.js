...
function render(inputs, position=[0,0,0]) {
  ...
  for (let i = 0; i < verts.length; i++) {
    if (verts[i][2] != 0) {
      var realz = verts[i][2]/30+((z + position['2'])/300)
    }
    else {
      var realz = ((z + position['2'])/300)
    }
    if (realz < 0) {
      realz = 0;
    }
    rverts[i][0] = (verts[i][0]*10)/(realz)+centerx+((x+position[0])/realz)
    rverts[i][1] = (verts[i][1]*10)/(realz)+centery+((y+position[1])/realz)
    /*
    ctx.fillStyle=color;
...
var models = JSON.parse('{"model": {"version": 1.1,"vertexs": [[-10,-10,-5],[10,10,-5],[-10,10,-5],[10,-10,-5],[-10,-10,5],[10,10,5],[-10,10,5],[10,-10,5]],"edges": [[1,3],[0,2],[0,3],[1,2],[1,5],[2,6],[3,7],[0,4],[4,6],[4,7],[5,7],[5,6]],"faces": [[4,7,5,6],[5,1,2,6],[0,3,1,2]]}, "model2": {"version": 1.1,"vertexs": [[-5,-5,-2.5],[5,5,-2.5],[-5,5,-2.5],[5,-5,-2.5],[-5,-5,2.5],[5,5,2.5],[-5,5,2.5],[5,-5,2.5]],"edges": [[1,3],[0,2],[0,3],[1,2],[1,5],[2,6],[3,7],[0,4],[4,6],[4,7],[5,7],[5,6]],"faces": [[4,7,5,6],[5,1,2,6],[0,4,7,3],[0,3,1,2]]}}')
...
var url = '/cubes.mx3';
var version = 1.1;
var cubes = [[models['model'], [-100,-200,0]], [models['model2'], [200,0,200]]];
var screendist = 300;
